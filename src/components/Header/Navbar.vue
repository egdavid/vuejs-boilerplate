<template>
  <b-navbar toggleable="lg" type="dark" variant="primary" class="mb-3">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav>
        <router-link class="nav-item" tag="li" :to="{ name: 'repository' }">
          <a class="nav-link">Repository</a>
        </router-link>
        <router-link class="nav-item" tag="li" :to="{ name: 'portal' }">
          <a class="nav-link">Portal</a>
        </router-link>
        <router-link class="nav-item" tag="li" :to="{ name: 'profile' }">
          <a class="nav-link">Profile (protected route)</a>
        </router-link>
      </b-navbar-nav>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-form v-else v-on:submit.prevent>
          <b-form-input
